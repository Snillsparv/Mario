...
export const FACE_HINT = "Drag Pip's face!  ·  Enter to play";
export const FACE_HINT_PAD = "Drag Pip's face!  ·  START to play";
export const FACE_HINT_TOUCH = "Drag Pip's face!  ·  START or tap here to play";
